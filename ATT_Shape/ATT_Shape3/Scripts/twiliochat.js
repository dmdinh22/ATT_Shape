...
var twiliochat = (function () {
    ...
    $(document).ready(function () {
        ...
        $deleteChannelBtn = $('#delete-channel-btn');
        ...
        $('#connect-channel').on('click', connectClientWithUsername);
        $('#add-channel-btn').on('click', showAddChannelInput);
        $('#leave-span').on('click', disconnectClient);
        $('#delete-channel-btn').on('click', deleteCurrentChannel);
    });
    ...
    function updateConnectedUI() {
        ...
        $deleteChannelBtn.removeClass('hidden');
        $connectBtn.hide();
        $usernameInput.hide();
    ...
    function disconnectClient() {
        ...
        $deleteChannelBtn.addClass('hidden');
        $connectBtn.show();
        $usernameInput.show();
        $('#username-span').text('');
